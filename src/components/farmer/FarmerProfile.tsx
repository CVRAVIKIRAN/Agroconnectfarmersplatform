import { User, MapPin, Phone, LogOut, Calendar } from 'lucide-react';
...
export function FarmerProfile({ user, onLogout }: FarmerProfileProps) {
  return (
          ...
          <CardHeader>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Verified Farmer</p>
              </div>
            </div>
          </CardHeader>
